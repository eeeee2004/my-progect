  ...
  <el-container>
    <el-header class="hotel-header">
      <div class="header-left">
        <span class="header-brand">👑 系统管理</span>
        <el-menu mode="horizontal" :default-active="activeMenu" router background-color="transparent" text-color="rgba(255,255,255,0.75)" active-text-color="#C8A25C">
          ...
          <el-menu-item index="/admin/price-calendar">房价日历</el-menu-item>
        </el-menu>
      </div>
      <div class="header-right">
        <span class="user-name">{{ userStore.userInfo?.realName || userStore.employeeInfo?.realName }}</span>
